...
final class TalkTTSValidationTests {
    @Test func `resolve speed uses rate WPM when provided`() {
    ...
    @Test func `validated unit bounds`() {
    ...
    @Test func `validated seed bounds`() {
    ...
    @Test func `validated latency tier`() {
    ...
    @Test func `pcm sample rate parse`() {
